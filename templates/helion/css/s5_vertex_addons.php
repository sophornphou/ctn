...
/*			position: fixed;*/
	...
	#s5_menu_wrap.s5_wrap {	
     ...
     <?php if ($s5_fmenuslidein  == "yes") { ?>
         #s5_menu_wrap { -webkit-transition:  all <?php echo $s5_menumilliseconds; ?>ms ease-in 0s;-moz-transition:  all <?php echo $s5_menumilliseconds; ?>ms ease-in 0s;-o-transition: all <?php echo $s5_menumilliseconds; ?>ms ease-in 0s;transition:  all <?php echo $s5_menumilliseconds; ?>ms ease-in 0s;    top:-<?php echo $s5_fmenuheight; ?>px;}
         #s5_menu_wrap.s5_wrap_fmfullwidth {    -webkit-transition: all <?php echo $s5_menumilliseconds; ?>ms ease-out 0s; -moz-transition:all <?php echo $s5_menumilliseconds; ?>ms ease-out 0s;-o-transition: all <?php echo $s5_menumilliseconds; ?>ms ease-out 0s;transition:  all <?php echo $s5_menumilliseconds; ?>ms ease-out 0s;}
	<?php } ?>	
